...
from simulator.envs_zh_1001 import *
import numpy as np
...
while T < max_iter:
    ...
    time_step_courier_state_file_name_exchange = "D:/exchange/train/baseline/SD-OSquare-record-1001" \
                                                 "/time_step_" + str(T) + "_courier_state.txt"
    time_step_courier_state_file_name_encounter = "D:/exchange/train/baseline/SD-Osquare-encounter-1001" \
