...
if __name__ == "__main__":
    ...
    while T < max_iter:
        ...
        time_step_courier_state_file_name_exchange = "D:/exchange/train/baseline/DQN-update-record/time_step_" + str(
            T) + "_courier_state.txt"
        time_step_courier_state_file_name_encounter = "D:/exchange/train/baseline/DQN-update-encounter-record" \
                ...
                if courier_encounter_distance < 0.01 and \
                    ...
                    if isNewEncounterEvent:
                        ...
                        if len(low_level_state_input) > 12:
                            continue
                        low_level_action_list = DQN.choose_action(np.array(low_level_state_input))  # 输出了0/1, 0 表示不换
