...
max_iter = 60 * 60 * 7  # 10s一个时间步=8640，可能有很多空白时间点-----10min
...
while True:
    ...
    with open(
            "D:/exchange/train/baseline/DQN_train_logs/v0/train_log/train_20211221_time_iter7_to_14.txt",
            'a+') as logf:
    ...
    if running_reward_ep >= 0.35 or global_step % 5 == 0:
        os.mkdir(
            "D:/exchange/train/baseline/DQN_train_logs/v0/checkpoint/{}".format(global_step))
        saver.save(sess, "D:/exchange/train/baseline/DQN_train_logs/v0/checkpoint/{}/".format(
            global_step) + "model_{}.ckpt".format(global_step))
        print("save: ", "D:/exchange/train/baseline/DQN_train_logs/v0/checkpoint/{}/".format(
            global_step) + "model_{}.ckpt".format(global_step))
