...
# saver = tf.compat.v1.train.Saver()
#
# saver.restore(sess,'D:/exchange/train/optimize-2022-1-19/main/conv3/20200306_attention_conv_times_batch_50_courier_reward_state_MHA_GRU_conv-filter/before/low/255/model_255.ckpt')
...
# sess = tf.compat.v1.Session()
saver = tf.compat.v1.train.Saver()
# saver.restore(sess,'D:/exchange/train/optimize-2022-1-19/main/20200306_attention_conv_times_batch_50_courier_reward/160/model_160.ckpt')
saver.restore(sess,'D:/exchange/train/optimize-2022-1-19/main/conv3/20200306_attention_conv_times_batch_50_courier_reward_state_MHA_GRU_conv-filter/412/model_412.ckpt')
# D:\exchange\train\optimize-2022-1-19\main\conv3\20200306_attention_conv_times_batch_50_courier_reward_state_MHA_GRU_conv-filter\396
episode_ep_reward = []
...
if __name__ == "__main__":
    ...
    while T < max_iter:
        time_step_courier_state_file_name_exchange = "D:/exchange/train/optimize-2022-1-19/main/conv3/20200306_attention_conv_times_batch_50_courier_reward_state_MHA_GRU_conv-filter" \
                                                     "/test_zh1001_412/state/time_step_" + str(T) + "_courier_state.txt"
        time_step_courier_state_file_name_encounter = "D:/exchange/train/optimize-2022-1-19/main/conv3/20200306_attention_conv_times_batch_50_courier_reward_state_MHA_GRU_conv-filter" \
                                                      "/test_zh1001_412/encounter/time_step_" + str(T) + "_encounter.txt"
                    ...
                    if isNewEncounterEvent:
                        ...
                        with open(time_step_courier_state_file_name_encounter, 'a') as file:
                            file.writelines('time:' + str(T) +
                                            ...
                                            ', courier1_loc: (' + str(
                                online_couriers[online_courier_count_x].lat) + ',' +
                        ...
                        #             with open(
                        #                     "D:/exchange/train/optimize-2022-1-19/main/conv3/20200306_attention_conv_times_batch_50_courier_reward_state_MHA_GRU_conv-filter/low_train_log/train_20220125_time_iter7_to_14.txt",
                        #                     'a+') as logf:
                        #
                        ...
                        #                 'D:/exchange/train/optimize-2022-1-19/main/conv3/20200306_attention_conv_times_batch_50_courier_reward_state_MHA_GRU_conv-filter/low_c_loss.txt',
                        #                 'a')
                        ...
                        #                 'D:/exchange/train/optimize-2022-1-19/main/conv3/20200306_attention_conv_times_batch_50_courier_reward_state_MHA_GRU_conv-filter/low_a_loss.txt',
                        #                 'a')
                        ...
                        #                 os.mkdir(
                        #                     "D:/exchange/train/optimize-2022-1-19/main/conv3/20200306_attention_conv_times_batch_50_courier_reward_state_MHA_GRU_conv-filter/low_checkpoint/{}".format(
                        ...
                        #     global_step += 1
                        #     with open(
                        #             "D:/exchange/train/optimize-2022-1-19/main/conv3/20200306_attention_conv_times_batch_50_courier_reward_state_MHA_GRU_conv-filter/high_train_log/train_20220125_time_iter7_to_14.txt",
                        #             'a+') as logf:
                        ...
                        #         os.mkdir(
                        #             "D:/exchange/train/optimize-2022-1-19/main/conv3/20200306_attention_conv_times_batch_50_courier_reward_state_MHA_GRU_conv-filter/high_checkpoint/{}".format(
                        #                 global_step))
                        #         saver.save(sess,
                        #                    "D:/exchange/train/optimize-2022-1-19/main/conv3/20200306_attention_conv_times_batch_50_courier_reward_state_MHA_GRU_conv-filter/high_checkpoint/{}/".format(
                        ...
                        #         'D:/exchange/train/optimize-2022-1-19/main/conv3/20200306_attention_conv_times_batch_50_courier_reward_state_MHA_GRU_conv-filter/high_c_loss.txt',
                        #         'a')
                        #     high_critic_loss_record.write(str(hierachical_critic.cost_his[-50:]) + '\n')
                        #     high_critic_loss_record.close()
                        #
                        #     high_actor_loss_record = open(
                        #         'D:/exchange/train/optimize-2022-1-19/main/conv3/20200306_attention_conv_times_batch_50_courier_reward_state_MHA_GRU_conv-filter/high_a_loss.txt',
                        #         'a')
